    ...
    return (
        <div className="min-h-screen bg-neutral-50 flex">
            ...
            <aside className="w-64 bg-white border-r border-neutral-200 fixed inset-y-0 z-50">
                <div className="p-6">
                    <Link href="/forms" className="flex items-center gap-2 mb-8">
                ...
                <div className="absolute bottom-0 w-full p-6 border-t border-neutral-100">
                    <button
                        ...
                        className="flex items-center gap-3 text-neutral-600 hover:text-neutral-900 font-medium transition-colors w-full"
                    >
